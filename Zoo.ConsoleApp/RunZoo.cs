...
namespace Zoo.ConsoleApp
{
    public class RunZoo
    {
        public static void RunZooApp()
        {

            ZooLab.Zoo zoo1 = new ZooLab.Zoo("zoo-1", new ZooConsole());
            ZooLab.Zoo zoo2 = new ZooLab.Zoo("zoo-2", new ZooConsole());
            ZooApp.AddZoo(zoo1);
            ZooApp.AddZoo(zoo2);
            ...
            veterinarian1.AvailableMedicine.Add(new AntiInflammetory());

            veterinarian2.AvailableMedicine.Add(new Antibiotics());
            veterinarian2.AvailableMedicine.Add(new AntiDepression());
            veterinarian2.AvailableMedicine.Add(new AntiInflammetory());

            veterinarian3.AvailableMedicine.Add(new Antibiotics());
            veterinarian3.AvailableMedicine.Add(new AntiDepression());
            veterinarian3.AvailableMedicine.Add(new AntiInflammetory());

            veterinarian4.AvailableMedicine.Add(new Antibiotics());
            veterinarian4.AvailableMedicine.Add(new AntiDepression());
            veterinarian4.AvailableMedicine.Add(new AntiInflammetory());

            veterinarian1.Experience.Add(lion1.GetType().Name);
            veterinarian1.Experience.Add(snake1.GetType().Name);
            ...
            veterinarian2.Experience.Add(lion1.GetType().Name);
            veterinarian2.Experience.Add(snake1.GetType().Name);
            ...
            veterinarian3.Experience.Add(lion2.GetType().Name);
            veterinarian3.Experience.Add(snake2.GetType().Name);
            ...
            veterinarian4.Experience.Add(lion2.GetType().Name);
            veterinarian4.Experience.Add(snake2.GetType().Name);
